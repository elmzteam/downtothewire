...
module.exports = {
	...
	adminInfo: {
		"ben": {
			name: "Ben Zhang",
			handle: "ben",
			bio: (new handlebars.SafeString("<b>Ben</b> is a coder and tinkerer who studies <s>the liberal arts</s> computer science and possibly also other things at the College of William and Mary. He likes procedural generation and worldbuilding and coming up with game mechanics. He dabbles with composition, animation, and graphic design; he's into creative writing and music and tries to draw occasionally; and he likes semicolons too much.")),
		...
		"ellis": {
			...
			handle: "ellis",
			image: "ellis.png",
			bio: (new handlebars.SafeString("<b>Ellis</b> is studying Computer Science at the University of Virginia. He appreciates modern designs and loves hackathons, mechanical keyboards, and EDM. When he's not using an Intellij IDE, Ellis can be found messing with Photoshop or playing SSB4.")),
		...
		"thomas": {
			name: "Thomas Lee",
			handle: "thomas",
			bio: (new handlebars.SafeString("<b>Thomas</b> is currently a student in CWRU majoring in CS and considering electrical engineering. If you are interested on what Thomas has been up to, here's his github: <a href='https://github.com/tomatocurry1'>github.com/tomatocurry1</a>")),
